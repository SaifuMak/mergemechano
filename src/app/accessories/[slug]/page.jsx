...
export default function AccessoriesPage() {
    ...
    const categories = [
        {
            name: 'Dent Puller Accessories',
            image: '/images/cat1.png',
            slug: 'dent-puller',
        },
        {
            name: 'Battery Charger Accessories',
            image: '/images/cat2.png',
            slug: 'battery-charger',
        },
        {
            name: 'Spot Welder Accessories',
            image: '/images/cat3.png',
            slug: 'spot-welder',
        },
        {
            name: 'Mig Welding Accessories',
    ...
    return (
        ...
        <main className="min-h-[80vh]  transition-all duration-500 ease-in-out">
            <TitleBanner title="Our Accessories" description="Lorem ipsum dolor sit amet consectetur." />
