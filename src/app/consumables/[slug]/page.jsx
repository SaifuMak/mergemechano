...
export default function ConsumablesPage() {
    ...
    const categories = [
        {
            name: 'Dent Puller Consumables',
            image: '/images/cat1.png',
            slug: 'dent-puller',
        },
        {
            name: 'Battery Charger Consumables',
            image: '/images/cat2.png',
            slug: 'battery-charger',
        },
        {
            name: 'Spot Welder Consumables',
    ...
    return (
        <main className="min-h-[80vh]  transition-all duration-500 ease-in-out">
            <TitleBanner title="Our Consumables" description="Lorem ipsum dolor sit amet consectetur." />
