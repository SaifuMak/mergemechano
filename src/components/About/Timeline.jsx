...
export default function Timeline() {
    ...
    return (
        ...
        <div className="w-full h-full ">
            ...
            <div className="relative   w-11/12 lg:w-9/12  mx-auto my-5 md:p-6 max-md:p-8">

                <div className="absolute top-0 md:left-1/2 transform -translate-x-1/2 h-full w-1 flex flex-col">
                    <div className="md:h-[100px] h-[150px] bg-transparent "></div>
                ...
                {timelineData.map((event, index) => {
                    ...
                    return (
                        ...
                        >
                            <div className={`w-full md:w-5/12 max-sm:ml-2 ${isLeft ? 'md:order-1' : 'md:order-3'} order-2`}>
